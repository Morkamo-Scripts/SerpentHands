...
public class KeycardInitiator : CustomKeycard
{
    ...
    public override string Name { get; set; } = "Ключ-карта Зачинщика отряда 'Длань Змея'";
    public override string Description { get; set; } = "Ключ-карта Зачинщика отряда 'Длань Змея'";
    public override float Weight { get; set; } = 1;
    public override SpawnProperties SpawnProperties { get; set; } = null;
    public override ItemType Type { get; set; } = ItemType.KeycardCustomTaskForce;
    public override string KeycardLabel { get; set; } = "SH Initiator";
    
    public SerializableColor KeycardLabelColorRaw { get; set; } = new() { R = 90, G = 0, B = 33, A = 255 };
    public SerializableColor KeycardPermissionsColorRaw { get; set; } = new() { R = 255, G = 180, B = 60, A = 255 };
    public SerializableColor TintColorRaw { get; set; } = new() { R = 90, G = 0, B = 33, A = 255 };
    ...
    public override string KeycardName { get; set; } = "Sh. Initiator";
    public override string SerialNumber { get; set; } = "106049939173079096";
